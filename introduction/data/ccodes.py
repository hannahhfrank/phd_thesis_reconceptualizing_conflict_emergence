...
# This file creates a df with country codes, using different definitions. 
# df_ccodes.csv includes various definitions (see below) and df_ccodes_gw.csv
# saves the Gleditsch and Ward country codes. 

# Sources: 
#http://ksgleditsch.com/statelist.html
#https://wits.worldbank.org/wits/wits/witshelp/content/codes/country_codes.htm 
#(double check Congo and DRC with codes in downloaded WB data)
...
c_codes = { 'Abkhazia': [396,'XYZ','XYZ','XYZ',99999999,99999999,99999999],
            ...
            'Belize': [80, 'BLZ', '084', 'BLZ', 84, 22, 149],
            ...
            "Czechoslovakia":[315,'XYZ','XYZ','XYZ',99999999,236,99999999],
            ...
            'German Democratic Republic': [265,'XYZ','XYZ','XYZ',99999999,499,137],
            ...
            'Liechtenstein': [223, 'LIE', '438', 'LIE', 438, 114, 172],
            ...
            'Taiwan': [713, 'XYZ', '158', 'TAW', 158, 201, 48],
            'Togo': [461, 'TGO', '768', 'TOG', 768, 204, 134],
            ###'Tokelau': [99999999, 'TKL', '772', 'TKL', 99999999, 99999999, 99999999],
            'Tonga': [972, 'TON', '776', 'TON', 776, 206, 99999999],
            ...
            'Venezuela': [101, 'VEN', '862', 'VEN', 862, 222, 51],
            ...
            "Yemen, People's Republic of": [680, 'XYZ', 'XYZ', 'XYZ', 99999999, 406, 23],
            'Yugoslavia': [345, 'XYZ', 'XYZ', 'XYZ', 99999999, 235, 99999999],
            'Zambia': [551, 'ZMB', '894', 'ZAM', 894, 230, 61],
            'Zimbabwe': [552, 'ZWE', '716', 'ZIM', 716, 231, 62],
            }

# Convert dictionary into df and save
