...
# Load ACLED data and subset protest
...
agg_month.columns = ["dd","year","country","gw_codes","acled_codes","n_protest_events","fatalities"]
...
agg_month = agg_month.sort_values(by=["country","year","dd"])
agg_month.reset_index(drop=True,inplace=True)
agg_month.to_csv("data_out/acled_cm_protest.csv",sep=',')
