...
ucdp_date = ucdp_ss[["year","dd_date_start","dd_date_end","active_year","country","country_id","date_prec","best","high","low","month_date_start","month_date_end"]].copy(deep=True)
...
ucdp_final.reset_index(drop=True,inplace=True)
ucdp_final.to_csv("data_out/ucdp_cm_sb.csv",sep=',')
