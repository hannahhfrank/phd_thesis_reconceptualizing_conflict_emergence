...
# Customized legend 1
entries1 = [mpatches.Patch(color='black',label='1,000-fatality'),mpatches.Patch(color='gray',label='25-fatality'),mpatches.Patch(color='forestgreen',label='Protest'),mpatches.Patch(color='lightgreen',label='Riots'),mpatches.Patch(color='steelblue',label='Terrorism'), mpatches.Patch(color='lightblue',label='Battles'),mpatches.Patch(color='purple',label='Non-state'),mpatches.Patch(color='violet',label='One-sided')]
